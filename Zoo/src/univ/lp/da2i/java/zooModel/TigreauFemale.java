...
/**
 * La classe TigreauFemale eprsente les tigreau femelle
 * 
 ...
 * 
 */
public class TigreauFemale extends Tigres implements Bebe{

	/**
	 * Constructeur de TigreauFemale
	 * 
	 ...
	 */
	public TigreauFemale(String name, double poids, double taille, int age, boolean isHungry,
