...
/**
 * La classe Aiglonfemale reprsente un aiglon femelle
 * 
...
public class AiglonFemale extends Aigle implements Bebe{

	/**
	 * Constructeur de AiglonFemale
	 * 
	...
	public AiglonFemale(String name, double poids, double taille, int age, boolean isHungry, boolean isSleeping,
			boolean isHealthy) {
